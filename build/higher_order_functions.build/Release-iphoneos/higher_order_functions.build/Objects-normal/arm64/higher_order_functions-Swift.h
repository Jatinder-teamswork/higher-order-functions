...
#ifndef HIGHER_ORDER_FUNCTIONS_SWIFT_H
#define HIGHER_ORDER_FUNCTIONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="higher_order_functions",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22higher_order_functions11AppDelegate")
...
SWIFT_CLASS("_TtC22higher_order_functions13SceneDelegate")
...
SWIFT_CLASS("_TtC22higher_order_functions14ViewController")
